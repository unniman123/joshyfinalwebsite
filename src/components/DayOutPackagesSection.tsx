  ...
  return (
    <section className="py-12 bg-background">
      <div className="container mx-auto px-4">
        {/* Section Header */}
        <div className="text-center mb-8">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4" style={{ fontFamily: "'Sora', sans-serif" }}>
            {sectionTitle}
          </h2>
          <div className="w-24 h-1 bg-gradient-brand mx-auto mb-6"></div>
        </div>
              ...
              <CardContent className="px-2 py-2" style={{ backdropFilter: 'blur(4px)', boxShadow: '0 6px 18px rgba(0,0,0,0.08)' }}>
                <form onSubmit={handleFormSubmit} className="space-y-1.5">
                  ...
                  <div className="space-y-0.5">
                    <Label htmlFor="dayOut-name" className="text-[12px] text-black">
                      Name *
                    </Label>
                    <div className="relative">
                  ...
                  <div className="space-y-0.5">
                    <Label htmlFor="dayOut-mobile" className="text-[12px] text-black">
                      Mobile No (WhatsApp) *
                    </Label>
                    <div className="relative">
                  ...
                  {/* Date Field */}
                  <div className="space-y-0.5">
                    <Label htmlFor="dayOut-date" className="text-[12px] text-black">
                      Preferred Date *
                    </Label>
                    <div className="relative">
                  ...
                  <div className="space-y-0.5">
                    <Label htmlFor="dayOut-people" className="text-[12px] text-black">
                      Number of People *
                    </Label>
                    <div className="relative">
                  ...
                  {/* Destination Field */}
                  <div className="space-y-0.5">
                    <Label htmlFor="dayOut-destination" className="text-[12px] text-black">
