...
const Footer = () => {
  ...
  return <footer className="bg-slate-900 text-white w-full">
        ...
        <div className="space-y-2">
          ...
          <ul className="space-y-1">
            {quickLinks.map(link => <li key={link.name}>
              <Link to={link.href} className="text-white/80 hover:text-rose-300 transition-smooth">
                {link.name}
              </Link>
            </li>)}
          </ul>
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-1.5">
            <div className="flex items-center gap-2">
              <Phone className="h-4 w-4 flex-shrink-0" style={{ color: 'hsl(345 65% 55%)' }} />
              <span className="text-xs text-white/80">+91-95395-07516, +91-471-2488880</span>
            </div>
            <div className="flex items-center gap-2">
              <Mail className="h-4 w-4 flex-shrink-0" style={{ color: 'hsl(345 65% 55%)' }} />
              <span className="text-xs text-white/80">KeralaToursGlobal@gmail.com, flabour@gmail.com</span>
            </div>
            <div className="flex items-start gap-2">
              <MapPin className="h-4 w-4 flex-shrink-0 mt-1" style={{ color: 'hsl(345 65% 55%)' }} />
    ...
    <div className="flex flex-col md:flex-row justify-between items-center gap-1 text-xs text-white/80">
      <div style={{ fontFamily: "'Roboto', 'Helvetica Neue', 'Arial', 'Noto Sans', sans-serif" }} className="font-medium">
        © KeralaTours Travels & Organic Remedies. All rights reserved.
      </div>
      <div className="flex gap-4">
        <Link to="/terms" className="hover:text-rose-300 transition-smooth">Terms of Service</Link>
        <Link to="/privacy" className="hover:text-rose-300 transition-smooth">Privacy Policy</Link>
        <Link to="/cookies" className="hover:text-rose-300 transition-smooth">Cookie Policy</Link>
      </div>
    </div>
  </footer>;
};
