        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-wrap gap-2">
            <a href="https://www.Facebook.com/GoIntoAllTheWorld.in" target="_blank" rel="noopener noreferrer"
              className="w-8 h-8 bg-white/10 hover:bg-golden/20 rounded-full flex items-center justify-center transition-smooth group">
              <Facebook className="h-4 w-4 text-white group-hover:text-golden" />
            </a>
            <a href="https://www.instagram.com/keralatoursglobalktg?igsh=cmdoOGtoMWpvMm9y" target="_blank" rel="noopener noreferrer"
              className="w-8 h-8 bg-white/10 hover:bg-golden/20 rounded-full flex items-center justify-center transition-smooth group">
              <Instagram className="h-4 w-4 text-white group-hover:text-golden" />
            </a>
            <a href="https://x.com/joshiflabour?s=09" target="_blank" rel="noopener noreferrer"
              className="w-8 h-8 bg-white/10 hover:bg-golden/20 rounded-full flex items-center justify-center transition-smooth group">
              <Twitter className="h-4 w-4 text-white group-hover:text-golden" />
            </a>
            <a href="https://www.linkedin.com/company/keralatoursglobal_tourism-kerala-india-1/" target="_blank" rel="noopener noreferrer"
              className="w-8 h-8 bg-white/10 hover:bg-golden/20 rounded-full flex items-center justify-center transition-smooth group">
              <Linkedin className="h-4 w-4 text-white group-hover:text-golden" />
            </a>
            <a href="https://pin.it/12qgTCdKJ" target="_blank" rel="noopener noreferrer"
              className="w-8 h-8 bg-white/10 hover:bg-golden/20 rounded-full flex items-center justify-center transition-smooth group">
              <svg className="h-4 w-4 text-white group-hover:text-golden" viewBox="0 0 24 24" fill="currentColor">
